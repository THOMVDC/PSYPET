function [rbv_path]=LTNP_PVC_RBV(subject,rbv_script_dir,pet_path,seg_path,output_folder)
...
% Run script
rbv_path=py.PVC_RBV_calculation_Nathalie.rbv_pvc(subject,pet_path,seg_path,output_folder);
