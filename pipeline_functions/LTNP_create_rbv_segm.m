function [output_segm_and_skull_path,MENGSKULL_path,GMWMCSFmask_path,output_segm_path]=LTNP_create_rbv_segm(GMmask_path, WMmask_path, CSFmask_path, atlas_path, output_folder)
