function [rbv_path]=LTNP_PVC_RBV(rbv_script_dir,pet_path,seg_path,output_folder,fwhm)
...
% Run script
rbv_path=py.PVC_RBV_calculation_Nathalie.rbv_pvc(pet_path,seg_path,output_folder,fwhm);
